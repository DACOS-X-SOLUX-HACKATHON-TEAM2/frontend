...
const Q10: React.FC = () => {
  ...
  const topics = [
    { num: "1", path: "/question/11", name: "볼에 모공이 꽤 있는 편이다." },
    { num: "2", path: "/question/11", name: "보통이다." },
    { num: "3", path: "/question/11", name: "볼에 모공이 별로 없다." },
  ];
  ...
  return (
    <div css={qAppContainer}>
      <div css={qContent}>
        ...
        <h3 css={qQuestion}>Q. 볼의 모공 정도를 선택하세요.</h3>
        <div css={qButtonGrid}>
          {topics.map((topic) => (
            <button
              key={topic.num}
