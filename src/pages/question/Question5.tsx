...
const Q5: React.FC = () => {
  ...
  const topics = [
    { num: "1", path: "/question/6", name: "피부 잡티가 꽤 있는 편이다." },
    { num: "2", path: "/question/6", name: "보통이다." },
    { num: "3", path: "/question/6", name: "피부 잡티가 별로 없다." },
  ];
  ...
  return (
    <div css={qAppContainer}>
      <div css={qContent}>
        ...
        <h3 css={qQuestion}>Q. 피부 잡티의 정도를 선택하세요.</h3>
        <div css={qButtonGrid}>
          {topics.map((topic) => (
            <button
              key={topic.num}
